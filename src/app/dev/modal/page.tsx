      ...
      <div className="py-8">
        ...
        <section className="mb-12">
          <h2 className="text-heading-md-css font-semibold text-foreground mb-6">
            Button Style Test (for Modal Footer)
          </h2>
          <div className="p-6 bg-muted rounded-lg space-y-4">
            <div className="flex gap-4 items-center">
              <span className="text-body-sm-css text-muted-foreground min-w-[120px]">Primary Fill:</span>
              <Button
                size="xs"
                variant="primary"
            ...
            <div className="flex gap-4 items-center">
              <span className="text-body-sm-css text-muted-foreground min-w-[120px]">Primary Outline:</span>
              <Button
                size="xs"
                variant="primary"
                colorVariant="default"
            ...
            <div className="flex gap-4 items-center">
              <span className="text-body-sm-css text-muted-foreground min-w-[120px]">기존 방식 (outline):</span>
              <Button
                size="xs"
                variant="outline"
              >
